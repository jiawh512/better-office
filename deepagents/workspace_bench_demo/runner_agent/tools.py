...
#   1. Add its import to runner_agent/harness.py (e.g. "from runner_agent.tools import ..., new_tool")
#   2. Register it in the tools=[...] list inside build_agent() in runner_agent/harness.py.
